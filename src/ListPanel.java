...
public abstract class ListPanel extends JPanel {
    ...
    public ListPanel() {
        ...
        scrollPane.setPreferredSize(new Dimension(Main.frame.getWidth() / 5, getHeight()));
    ...
    protected void addCategory(String category, JPanel content) {
        JPanel categoryPanel = createCategoryPanel(category);
        categoryPanels.put(category, categoryPanel);
        contentPanels.put(category, content);
    }
